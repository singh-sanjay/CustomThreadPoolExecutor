...
class WorkerThread extends Thread{
    ...
    private void tryFillingQueueFromFile() {
        System.out.println(Thread.currentThread().getName()+"::"+waitingTaskQueue.size()+":"+poolState.getTasksInFileStorage()+":"+isFileOperationInProcess.get()+":"+PREFILL_STARTING_LIMIT+":"+PREFILL_ENDING_LIMIT);
